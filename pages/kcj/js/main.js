...
$('p.a.home').click(function(){
	$('.content').css({'display':'none'});
	$('.content.main').css({'display':'inline'});
	$('.left.a.main-works').css({'display':'none'});
	$('.left.a.extra').css({'display':'none'});
	$('.left.b.works-list').css({'display':'none'});
	$('p.a').css({'font-style':'normal'})
	$('span.b').css({'font-style':'normal'})
...
$('p.a.about').click(function(){
	...
	$('.left.a.main-works').css({'display':'inline'});
	$('.left.a.extra').css({'display':'inline'});
	$('.left.b.works-list').css({'display':'inline'});
	$('p.a').css({'font-style':'normal'})
	$('span.b').css({'font-style':'normal'})
	$(this).css({'font-style':'italic'});
	$('.column.right').scrollTop(0);
